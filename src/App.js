...
class App extends Component {
  ...
  handleDelete = id => {
    ...
    const updatedHistoryList = latestHistoryList.filter(item => item.id !== id)
  ...
  render() {
    ...
    const filteredHistoryList = latestHistoryList.filter(item =>
...
const HistoryItem = ({historyItem, onDelete}) => {
